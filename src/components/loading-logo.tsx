...
export function LoadingLogo({ size = 120 }: { size?: number }) {
    return (
        <svg
        ...
        >
            ...
            .logo-wrapper {
              transform-origin: 1800px 1800px; /* Exact center of the 3600 viewBox */
              animation: logo-pulse 2.5s infinite ease-in-out;
            }

            /* Path Outline & Fill Animation */
            ...
            .logo-path {
              ...
              /* Using pathLength="100" lets us use 100 for dash percentages */
              stroke-dasharray: 100;
              stroke-dashoffset: 100;
              animation: drawAndFill 3s infinite ease-in-out;
            }

            /* Slightly stagger the inner logo detail */
